...
import { validationAddContact } from 'constants/validationData';
...
export const AddModal = ({ isOpen, handleClose }) => {
  ...
  const handleSubmit = ({ name, number }, { resetForm }) => {
    ...
    if (isNameAdded) {
      toast.error(`${name} is alredy in Phonebook`);
      return;
    } else if (isNumberAdded) {
      toast.error(`${number} is alredy in Phonebook`);
      return;
    }
  ...
  const formik = useFormik({
    ...
    validationSchema: validationAddContact,
